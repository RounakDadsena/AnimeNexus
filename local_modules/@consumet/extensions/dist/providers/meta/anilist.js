    ...
    constructor(provider, proxyConfig, adapter) {
        ...
        this.fetchAnimeInfo = async (id, dub = false, fetchFiller = false) => {
            ...
            try {
                ...
                animeInfo.totalEpisodes =
                    (_37 = (_36 = data.data.Media) === null || _36 === void 0 ? void 0 : _36.episodes) !== null && _37 !== void 0 ? _37 : ((_38 = data.data.Media.nextAiringEpisode) === null || _38 === void 0 ? void 0 : _38.episode) - 1;
        ...
        this.findAnimeRaw = async (slug, externalLinks) => {
            if (this.provider instanceof crunchyroll_1.default && externalLinks) {
                ...
                if (link) {
                    ...
                    if (request.res.responseUrl.includes('series') ||
        ...
        this.fetchRandomAnime = async () => {
            ...
            try {
                ...
                const { data } = await this.client.get('https://raw.githubusercontent.com/5H4D0WILA/IDFetch/main/ids.txt');
        ...
        this.fetchAnilistInfoById = async (id) => {
            ...
            try {
                ...
                animeInfo.totalEpisodes =
                    (_p = (_o = data.data.Media) === null || _o === void 0 ? void 0 : _o.episodes) !== null && _p !== void 0 ? _p : ((_q = data.data.Media.nextAiringEpisode) === null || _q === void 0 ? void 0 : _q.episode) - 1;
        ...
        this.fetchCharacterInfoById = async (id) => {
            ...
            try {
                ...
                const previousPosition = (_l = (_k = Character.description
                    .match(/__Previous Position:__(.*)/)) === null || _k === void 0 ? void 0 : _k[1]) === null || _l === void 0 ? void 0 : _l.trim();
