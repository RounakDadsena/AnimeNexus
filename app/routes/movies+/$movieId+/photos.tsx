...
export const meta = mergeMeta<typeof loader, { 'routes/movies+/$movieId': typeof movieIdLoader }>(
  ({ params, matches }) => {
    ...
    return [
      { title: `AnimeNexus - ${movieTitle} - Photos` },
      {
        property: 'og:url',
        content: `https://anime-nexus-six.vercel.app/movies/${params.movieId}/photos`,
      },
      { property: 'og:title', content: `AnimeNexus - ${movieTitle} - Photos` },
      { name: 'twitter:title', content: `AnimeNexus - ${movieTitle} - Photos` },
    ];
  },
);
