...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  return [
    {
      title: `AnimeNexus - Watch ${detail?.name || ''} season ${params.seasonId || ''} episode ${
        params.episodeId || ''
      }`,
    },
    ...
    {
      property: 'og:url',
      content: `https://anime-nexus-six.vercel.app/tv-shows/${params.tvId}/season/${params.seasonId}/episode/${params.episodeId}/watch`,
    },
    {
      property: 'og:title',
      content: `AnimeNexus - Watch ${detail?.name || ''} season ${params.seasonId || ''} episode ${
        params.episodeId || ''
      }`,
    },
