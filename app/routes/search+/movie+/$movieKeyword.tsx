...
export const meta = mergeMeta<typeof loader>(({ data, params }) => {
  ...
  return [
    { title: `AnimeNexus - Search results for ${params.movieKeyword}` },
    {
      name: 'keywords',
    ...
    {
      property: 'og:url',
      content: `https://anime-nexus-six.vercel.app/search/movie/${params.movieKeyword}`,
    },
    { property: 'og:title', content: `AnimeNexus - Search results for ${params.movieKeyword}` },
    {
      property: 'og:image',
    ...
    { name: 'twitter:title', content: `AnimeNexus - Search results for ${params.movieKeyword}` },
  ];
});
